...
dn_data_exp[dn_data_exp["gene_name"] == "CREB1"][["gene_name", "tf1p0_id", "dn_cat", "med_paired-brca_ratio",
                                                   "med_paired-ctrls_ratio", "med_paired-diff_ratio"]]
...
brca_expression_plot("CREB1", (9, 3), (0, 6), brca_isos_paired, cols, "paired",
                     ([0, 34.5], [0.2, 0.2]), ([34.5, 70], [0.25, 0.25]))
...
ax.set_xlabel("")
ax.set_ylabel("isoform ratio")
ax.set_title("CREB1 isoforms in breast cancer")
ax.get_legend().remove()
ax.set_ylim((-0.05, 1))

fig.savefig("../figures/BRCA_CREB1_boxplot.pdf", dpi="figure", bbox_inches="tight")
