...
ys = np.array(
    [
        len(cats[cats["partner_category"] == "TF"]),
        len(cats[cats["partner_category"] == "cofactor"]),
...
(
    pairs.loc[
        ...
        :,
    ].sort_values("activation_fold_change", ascending=True)
)[
    [
        "tf_gene_symbol",
        "clone_acc_a",
...
pairs[pairs["tf_gene_symbol"] == "PBX1"][
    [
        "tf_gene_symbol",
        "clone_acc_a",
        "clone_acc_b",
